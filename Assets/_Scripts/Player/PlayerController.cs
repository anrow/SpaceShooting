...
public class PlayerController : MonoBehaviour {
    ...
    void Start( ) {
        bulletPrefab = Instantiate( Resources.Load( "Prefabs/PlayerBullet" ) ) as GameObject; 
        GameObject bullet = (GameObject)Instantiate(Resources.Load("Prefabs/PlayerBullet", typeof(GameObject)));
    }
    void FixedUpdate( ) {
    ...
    void HandleMovement( ) {
        ...
        if( isShoot ) {
            ...
            //弾丸のクローン
            Instantiate( bulletPrefab, shotTrans.position, shotTrans.rotation );
